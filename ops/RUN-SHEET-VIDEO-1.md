...
## 4ג · ארבע בדיקות לפני שאתה מוסר — נוספו 21.8

הקטע הראשון שהתקבל נפסל על חמישה סעיפים, וארבעה מהם היו נראים בעין
בתוך עשר שניות. **תבדוק אותם בעצמך לפני המסירה**, ותרשום בדוח מה
מצאת — קטע שנופל וסומן שווה יותר מקטע שנופל ונמסר כתקין:

1. **כמה שניות?** הקטע חייב 8. הכלי נותן לפעמים 10 כברירת מחדל —
   אם אינך יכול לקבוע 8, **אמור זאת ואל תשנה שום דבר אחר.**
2. **האם הסוף שונה מההתחלה?** הפעל, ועצור בפריים הראשון ובאחרון.
   אם הם נראים אותו דבר — **המצלמה הלכה וחזרה, והקטע פסול.** התנועה
   מסתיימת במקום חדש ונחה שם.
3. **יש שמע?** אתה מוסר פריימים בלבד. יש רצועת קול — הסר, או דווח
   שאינך יכול.
4. **המסגרת המצוירת של הלוח — יוצאת מהפריים בשלב כלשהו?** אסור.
   אם התנועה חותכת אותה, היא רחוקה מדי.
